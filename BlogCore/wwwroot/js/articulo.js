...
//utlizmos la variable que declaramos arriva dataTable y luego mandamos a llamar el id de la Tabla en Index Articulo
function cargarDatatable() {
    dataTable = $("#tblArticulos").DataTable({
        "ajax": {
            "url": "/admin/articulos/GetAll",  //url de acceso al Area Admin en el controlador Articulo con el metodp GetAll 
