...
//utlizmos la variable que declaramos arriva dataTable y luego mandamos a llamar el id de la Tabla en Index Slide
function cargarDatatable() {
    dataTable = $("#tblSlider").DataTable({
        "ajax": {
            "url": "/admin/Sliders/GetAll",  //url de acceso al Area Admin en el controlador Slider con el metodp GetAll 
